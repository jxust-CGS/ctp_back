...
public class DwzRender extends Render {
	 ...
	 * 封装dwz返回的json字符串
	 */
	private static final long serialVersionUID = -1911895685839035114L;
	...
	public DwzRender(String message, String navTavId, String callbackType) {
		this.message = message;
		this.navTabId = navTavId;
